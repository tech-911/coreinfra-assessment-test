...
function DashWidget({ id, DashIcon, title }: quickAccessDataType) {
  return (
    <div
      key={id}
      className="flex flex-row items-center group gap-4 min-w-[250px] max-w-[300px] basis-[250px] flex-1 bg-background hover:bg-primary/10 rounded-[4px] min-h-[45px] px-4 py-2 cursor-pointer transition-all duration-200 ease-in-out"
    >
      <IconContainer>
